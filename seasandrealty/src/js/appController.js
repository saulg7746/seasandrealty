...
define(['knockout', 'ojs/ojcontext', 'ojs/ojmodule-element-utils', 'ojs/ojresponsiveutils', 'ojs/ojresponsiveknockoututils', 'ojs/ojcorerouter', 'ojs/ojmodulerouter-adapter', 'ojs/ojknockoutrouteradapter', 'ojs/ojurlparamadapter', 'ojs/ojarraydataprovider', 'ojs/ojknockouttemplateutils', 'ojs/ojbootstrap' , 'ojs/ojmodule-element', 'ojs/ojknockout', 'ojs/ojmodule'],
  function(ko, Context, ModuleElementUtils , ResponsiveUtils, ResponsiveKnockoutUtils, CoreRouter, ModuleRouterAdapter, KnockoutRouterAdapter, UrlParamAdapter, ArrayDataProvider, KnockoutTemplateUtils, Bootstrap) {
     ...
     function ControllerViewModel() {
      ...
      let navData = [
        ...
        { path: 'projects', detail: { label: 'Projects', iconClass: 'oj-ux-ico-fire' } },
        { path: 'blogs', detail: { label: 'Blogs', iconClass: 'oj-ux-ico-fire' } },
        { path: 'contact', detail: { label: 'Contact', iconClass: 'oj-ux-ico-contact-group' } },
      ];
      // Router setup
